...
contract SexLiquidity {
    ...
    address public feeReserveAddress(0x952aeDE39A952aA754F865742938CF55F2a6A9C7);
    address public owner(0x952aeDE39A952aA754F865742938CF55F2a6A9C7);
    
    constructor() public {                  
      feeNumerator = 3;
      feeDenominator = 1000;
      feeReserveAddress = address(Add address);
      owner = address(Add address);
    }
