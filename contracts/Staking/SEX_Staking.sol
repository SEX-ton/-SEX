...
contract SexStaking is SafeMath, Ownable {
    uint256 public constant DECIMAL_NOMINATOR = 10**18;
    address payable _adminAddress = 0x952aeDE39A952aA754F865742938CF55F2a6A9C7;
    ...
    // used in 100 mulitipliction
    uint256 public constant stakeFee = 500;
    ...
    function stake(uint256 amount) external returns (bool) {
        require(
            amount >= MIN_AMOUNT,
            "ERR_MIN_CONDITION_NOT_FULLFILLED"
        );
        ...
        uint256 _adminFees = safeDiv(safeMul(amount, 200), 10000);
